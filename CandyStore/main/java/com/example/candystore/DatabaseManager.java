...
public class DatabaseManager extends SQLiteOpenHelper {
    ...
    public void onCreate( SQLiteDatabase db ) {
        ...
        String sqlCreate = "create table " + TABLE_CANDY + "( " + ID; sqlCreate += " integer primary key autoincrement, " + NAME;
    ...
    public void onUpgrade( SQLiteDatabase db, int oldVersion, int newVersion ) {
        ...
        db.execSQL( "drop table if exists " + TABLE_CANDY ); // Re-create tables
        onCreate( db );
    }
